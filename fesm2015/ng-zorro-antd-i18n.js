...
// Merge into a locale object
const locale$N = {
    lang: Object.assign({ placeholder: 'აირჩიეთ თარიღი', rangePlaceholder: ['საწყისი თარიღი', 'ბოლო თარიღი'] }, Calendar$o),
    timePickerLocale: Object.assign({}, locale$M)
};
...
// Merge into a locale object
const locale$P = {
    lang: Object.assign({ placeholder: 'ದಿನಾಂಕ ಆಯ್ಕೆಮಾಡಿ', rangePlaceholder: ['ಪ್ರಾರಂಭ ದಿನಾಂಕ', 'ಅಂತಿಮ ದಿನಾಂಕ'] }, Calendar$p),
    timePickerLocale: Object.assign({}, locale$O)
};
...
// Merge into a locale object
const locale$R = {
    lang: Object.assign({ placeholder: '날짜 선택', rangePlaceholder: ['시작일', '종료일'] }, Calendar$q),
    timePickerLocale: Object.assign({}, locale$Q)
};
...
// Merge into a locale object
const locale$T = {
    lang: Object.assign({ placeholder: 'Dîrok hilbijêre', rangePlaceholder: ['Dîroka destpêkê', 'Dîroka dawîn'] }, Calendar$r),
    timePickerLocale: Object.assign({}, locale$S)
};
...
// Merge into a locale object
const locale$V = {
    lang: Object.assign({ placeholder: 'Izvēlieties datumu', rangePlaceholder: ['Sākuma datums', 'Beigu datums'] }, Calendar$s),
    timePickerLocale: Object.assign({}, locale$U)
};
...
// Merge into a locale object
const locale$X = {
    lang: Object.assign({ placeholder: 'Огноо сонгох', rangePlaceholder: ['Эхлэх огноо', 'Дуусах огноо'] }, Calendar$t),
    timePickerLocale: Object.assign({}, locale$W)
};
...
// Merge into a locale object
const locale$Z = {
    lang: Object.assign({ placeholder: 'Pilih tarikh', rangePlaceholder: ['Tarikh mula', 'Tarikh akhir'] }, Calendar$u),
    timePickerLocale: Object.assign({}, locale$Y)
};
...
// Merge into a locale object
const locale$$ = {
    lang: Object.assign({ placeholder: 'Velg dato', rangePlaceholder: ['Startdato', 'Sluttdato'] }, Calendar$v),
...
// Merge into a locale object
const locale$13 = {
    lang: Object.assign({ placeholder: 'Selecteer datum', rangePlaceholder: ['Begin datum', 'Eind datum'] }, Calendar$x),
...
// Merge into a locale object
const locale$15 = {
    lang: Object.assign({ placeholder: 'Wybierz datę', rangePlaceholder: ['Data początkowa', 'Data końcowa'] }, Calendar$y),
...
// Merge into a locale object
const locale$17 = {
    lang: Object.assign({ placeholder: 'Selecionar data', rangePlaceholder: ['Data de início', 'Data de fim'] }, Calendar$z),
...
const locale$19 = {
    ...
    timePickerLocale: Object.assign(Object.assign({}, locale$18), { placeholder: 'Hora' })
};
...
// Merge into a locale object
const locale$1b = {
    lang: Object.assign({ placeholder: 'Selectează data', rangePlaceholder: ['Data start', 'Data sfârșit'] }, Calendar$B),
 ...
 */
const locale$1d = {
    lang: Object.assign({ placeholder: 'Выберите дату', rangePlaceholder: ['Начальная дата', 'Конечная дата'] }, Calendar$C),
...
// 统一合并为完整的 Locale
const locale$1f = {
    lang: Object.assign({ placeholder: 'Vybrať dátum', rangePlaceholder: ['Od', 'Do'] }, Calendar$D),
...
// Merge into a locale object
const locale$1j = {
    lang: Object.assign({ placeholder: 'Izaberite datum', rangePlaceholder: ['Početni datum', 'Krajnji datum'] }, Calendar$F),
 ...
 */
const locale$1l = {
    lang: Object.assign({ placeholder: 'Välj datum', rangePlaceholder: ['Startdatum', 'Slutdatum'] }, Calendar$G),
...
// Merge into a locale object
const locale$1n = {
    lang: Object.assign({ placeholder: 'தேதியைத் தேர்ந்தெடுக்கவும்', rangePlaceholder: ['தொடக்க தேதி', 'கடைசி தேதி'] }, Calendar$H),
...
// Merge into a locale object
const locale$1p = {
    lang: Object.assign({ placeholder: 'เลือกวันที่', rangePlaceholder: ['วันเริ่มต้น', 'วันสิ้นสุด'] }, Calendar$I),
...
// Merge into a locale object
const locale$1r = {
    lang: Object.assign({ placeholder: 'Tarih Seç', rangePlaceholder: ['Başlangıç Tarihi', 'Bitiş Tarihi'] }, Calendar$J),
 ...
 */
const locale$1t = {
    lang: Object.assign({ placeholder: 'Оберіть дату', rangePlaceholder: ['Початкова дата', 'Кінцева дата'] }, Calendar$K),
...
// Merge into a locale object
const locale$1v = {
    lang: Object.assign({ placeholder: 'Chọn thời điểm', rangePlaceholder: ['Ngày bắt đầu', 'Ngày kết thúc'] }, Calendar$L),
 ...
 */
const locale$1x = {
    lang: Object.assign({ placeholder: '請選擇日期', rangePlaceholder: ['開始日期', '結束日期'] }, Calendar$M),
    timePickerLocale: Object.assign({}, locale$1w)
};
