...
export declare class NzCollapsePanelComponent implements OnInit, OnDestroy {
    ...
    clickHeader(): void;
    focusOnHeader(scrollTo?: boolean, scrollOptions?: ScrollIntoViewOptions): void;
    markForCheck(): void;
