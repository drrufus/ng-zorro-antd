...
/*! *****************************************************************************
    ...
    ***************************************************************************** */var d=function(e,n){return(d=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,n){e.__proto__=n}||function(e,n){for(var t in n)n.hasOwnProperty(t)&&(e[t]=n[t])})(e,n)};function h(e,n,t,i){var r,o=arguments.length,s=o<3?n:null===i?i=Object.getOwnPropertyDescriptor(n,t):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,n,t,i);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(n,t,s):r(n,t))||s);return o>3&&s&&Object.defineProperty(n,t,s),s}function m(e,n){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,n)}function z(e,n){var t="function"==typeof Symbol&&e[Symbol.iterator];if(!t)return e;var i,r,o=t.call(e),s=[];try{for(;(void 0===n||n-- >0)&&!(i=o.next()).done;)s.push(i.value)}catch(e){r={error:e}}finally{try{i&&!i.done&&(t=o.return)&&t.call(o)}finally{if(r)throw r.error}}return s}function v(){for(var e=[],n=0;n<arguments.length;n++)e=e.concat(z(arguments[n]));return e}var f=function(e){function t(){var n=null!==e&&e.apply(this,arguments)||this;return n.isInDropDown=!1,n}return function(e,n){function t(){this.constructor=e}d(e,n),e.prototype=null===n?Object.create(n):(t.prototype=n.prototype,new t)}(t,e),t.decorators=[{type:n.Injectable}],t}(r.NzMenuBaseService);var S=function(){function e(e,n){var r=this;this.nzHostSubmenuService=e,this.nzMenuService=n,this.disabled=!1,this.mode="vertical",this.mode$=this.nzMenuService.mode$.pipe(i.map((function(e){return"inline"===e?"inline":"vertical"===e||r.nzHostSubmenuService?"vertical":"horizontal"})),i.tap((function(e){return r.mode=e}))),this.level=1,this.level$=new t.BehaviorSubject(1),this.subMenuOpen$=new t.BehaviorSubject(!1),this.open$=new t.BehaviorSubject(!1),this.mouseEnterLeave$=new t.Subject,this.menuOpen$=t.combineLatest(this.subMenuOpen$,this.mouseEnterLeave$).pipe(i.map((function(e){return e[0]||e[1]})),i.auditTime(150),i.distinctUntilChanged(),i.tap((function(e){r.setOpenState(e),r.nzHostSubmenuService&&r.nzHostSubmenuService.subMenuOpen$.next(e)}))),this.nzHostSubmenuService&&this.setLevel(this.nzHostSubmenuService.level+1)}return e.prototype.setOpenState=function(e){this.open$.next(e)},e.prototype.onMenuItemClick=function(){this.setMouseEnterState(!1)},e.prototype.setLevel=function(e){this.level$.next(e),this.level=e},e.prototype.setMouseEnterState=function(e){"horizontal"!==this.mode&&"vertical"!==this.mode&&!this.nzMenuService.isInDropDown||this.disabled||this.mouseEnterLeave$.next(e)},e.decorators=[{type:n.Injectable}],e.ctorParameters=function(){return[{type:e,decorators:[{type:n.SkipSelf},{type:n.Optional}]},{type:f}]},e}();var g=function(){function e(e,n,r,s,a,u,l,p){var c=this;this.nzUpdateHostClassService=e,this.nzMenuService=n,this.nzSubmenuService=r,this.renderer=s,this.elementRef=a,this.routerLink=u,this.routerLinkWithHref=l,this.router=p,this.el=this.elementRef.nativeElement,this.destroy$=new t.Subject,this.originalPadding=null,this.selected$=new t.Subject,this.nzDisabled=!1,this.nzSelected=!1,this.nzMatchRouterExact=!1,this.nzMatchRouter=!1,p&&this.router.events.pipe(i.takeUntil(this.destroy$),i.filter((function(e){return e instanceof o.NavigationEnd}))).subscribe((function(){c.updateRouterActive()}))}return e.prototype.clickMenuItem=function(e){if(this.nzDisabled)return e.preventDefault(),void e.stopPropagation();this.nzMenuService.onMenuItemClick(this),this.nzSubmenuService&&this.nzSubmenuService.onMenuItemClick()},e.prototype.setClassMap=function(){var e,n=this.nzMenuService.isInDropDown?"ant-dropdown-menu-item":"ant-menu-item";this.nzUpdateHostClassService.updateHostClass(this.el,((e={})[""+n]=!0,e[n+"-selected"]=this.nzSelected,e[n+"-disabled"]=this.nzDisabled,e))},e.prototype.setSelectedState=function(e){this.nzSelected=e,this.selected$.next(e),this.setClassMap()},e.prototype.updateRouterActive=function(){var e=this;this.listOfRouterLink&&this.listOfRouterLinkWithHref&&this.router&&this.router.navigated&&this.nzMatchRouter&&Promise.resolve().then((function(){var n=e.hasActiveLinks();e.nzSelected!==n&&(e.nzSelected=n,e.setSelectedState(e.nzSelected))}))},e.prototype.hasActiveLinks=function(){var e=this.isLinkActive(this.router);return this.routerLink&&e(this.routerLink)||this.routerLinkWithHref&&e(this.routerLinkWithHref)||this.listOfRouterLink.some(e)||this.listOfRouterLinkWithHref.some(e)},e.prototype.isLinkActive=function(e){var n=this;return(function(t){return e.isActive(t.urlTree,n.nzMatchRouterExact)})},e.prototype.ngOnInit=function(){var e=this,n=this.el.style.paddingLeft;n&&(this.originalPadding=parseInt(n,10)),t.merge(this.nzMenuService.mode$,this.nzMenuService.inlineIndent$,this.nzSubmenuService?this.nzSubmenuService.level$:t.EMPTY).pipe(i.takeUntil(this.destroy$)).subscribe((function(){var n=null;"inline"===e.nzMenuService.mode?n=r.isNotNil(e.nzPaddingLeft)?e.nzPaddingLeft:(e.nzSubmenuService?e.nzSubmenuService.level+1:1)*e.nzMenuService.inlineIndent:n=e.originalPadding;n?e.renderer.setStyle(e.el,"padding-left",n+"px"):e.renderer.removeStyle(e.el,"padding-left")})),this.setClassMap()},e.prototype.ngAfterContentInit=function(){var e=this;this.listOfRouterLink.changes.pipe(i.takeUntil(this.destroy$)).subscribe((function(){return e.updateRouterActive()})),this.listOfRouterLinkWithHref.changes.pipe(i.takeUntil(this.destroy$)).subscribe((function(){return e.updateRouterActive()})),this.updateRouterActive()},e.prototype.ngOnChanges=function(e){e.nzSelected&&this.setSelectedState(this.nzSelected),e.nzDisabled&&this.setClassMap()},e.prototype.ngOnDestroy=function(){this.destroy$.next(),this.destroy$.complete()},e.decorators=[{type:n.Directive,args:[{selector:"[nz-menu-item]",exportAs:"nzMenuItem",providers:[r.NzUpdateHostClassService],host:{"(click)":"clickMenuItem($event)"}}]}],e.ctorParameters=function(){return[{type:r.NzUpdateHostClassService},{type:r.NzMenuBaseService},{type:S,decorators:[{type:n.Optional}]},{type:n.Renderer2},{type:n.ElementRef},{type:o.RouterLink,decorators:[{type:n.Optional}]},{type:o.RouterLinkWithHref,decorators:[{type:n.Optional}]},{type:o.Router,decorators:[{type:n.Optional}]}]},e.propDecorators={nzDisabled:[{type:n.Input}],nzSelected:[{type:n.Input}],nzPaddingLeft:[{type:n.Input}],nzMatchRouterExact:[{type:n.Input}],nzMatchRouter:[{type:n.Input}],listOfRouterLink:[{type:n.ContentChildren,args:[o.RouterLink,{descendants:!0}]}],listOfRouterLinkWithHref:[{type:n.ContentChildren,args:[o.RouterLinkWithHref,{descendants:!0}]}]},h([r.InputBoolean(),m("design:type",Object)],e.prototype,"nzDisabled",void 0),h([r.InputBoolean(),m("design:type",Object)],e.prototype,"nzSelected",void 0),h([r.InputBoolean(),m("design:type",Object)],e.prototype,"nzMatchRouterExact",void 0),h([r.InputBoolean(),m("design:type",Object)],e.prototype,"nzMatchRouter",void 0),e}();
/**
     * @license
