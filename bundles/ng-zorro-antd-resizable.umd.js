(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function getEventWithPoint(event) {
        return core$1.isTouchEvent(event) ? event.touches[0] || event.changedTouches[0] : event;
    }
    ...
    var NzResizableService = /** @class */ (function () {
        ...
        /** @nocollapse */ NzResizableService.ɵfac = function NzResizableService_Factory(t) { return new (t || NzResizableService)(core.ɵɵinject(core.NgZone), core.ɵɵinject(common.DOCUMENT)); };
        /** @nocollapse */ NzResizableService.ɵprov = core.ɵɵdefineInjectable({ token: NzResizableService, factory: NzResizableService.ɵfac });
        return NzResizableService;
    }());
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(NzResizableService, [{
    ...
    var NzResizableDirective = /** @class */ (function () {
        ...
        /** @nocollapse */ NzResizableDirective.ɵfac = function NzResizableDirective_Factory(t) { return new (t || NzResizableDirective)(core.ɵɵdirectiveInject(core.ElementRef), core.ɵɵdirectiveInject(core.Renderer2), core.ɵɵdirectiveInject(NzResizableService), core.ɵɵdirectiveInject(platform.Platform), core.ɵɵdirectiveInject(core.NgZone)); };
        /** @nocollapse */ NzResizableDirective.ɵdir = core.ɵɵdefineDirective({ type: NzResizableDirective, selectors: [["", "nz-resizable", ""]], hostBindings: function NzResizableDirective_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
                core.ɵɵallocHostVars(2);
                core.ɵɵlistener("mouseenter", function NzResizableDirective_mouseenter_HostBindingHandler($event) { return ctx.onMouseenter(); })("mouseleave", function NzResizableDirective_mouseleave_HostBindingHandler($event) { return ctx.onMouseleave(); });
            } if (rf & 2) {
                core.ɵɵclassProp("nz-resizable", true)("nz-resizable-resizing", ctx.resizing);
            } }, inputs: { nzBounds: "nzBounds", nzMaxHeight: "nzMaxHeight", nzMaxWidth: "nzMaxWidth", nzMinHeight: "nzMinHeight", nzMinWidth: "nzMinWidth", nzGridColumnCount: "nzGridColumnCount", nzMaxColumn: "nzMaxColumn", nzMinColumn: "nzMinColumn", nzLockAspectRatio: "nzLockAspectRatio", nzPreview: "nzPreview" }, outputs: { nzResize: "nzResize", nzResizeEnd: "nzResizeEnd", nzResizeStart: "nzResizeStart" }, exportAs: ["nzResizable"], features: [core.ɵɵProvidersFeature([NzResizableService])] });
        __decorate([
            core$1.InputBoolean(),
    ...
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(NzResizableDirective, [{
            type: core.Directive,
            args: [{
        ...
        }], function () { return [{ type: core.ElementRef }, { type: core.Renderer2 }, { type: NzResizableService }, { type: platform.Platform }, { type: core.NgZone }]; }, { nzBounds: [{
                type: core.Input
            }], nzMaxHeight: [{
                type: core.Input
            }], nzMaxWidth: [{
    ...
    var NzResizeHandleComponent = /** @class */ (function () {
        ...
        /** @nocollapse */ NzResizeHandleComponent.ɵfac = function NzResizeHandleComponent_Factory(t) { return new (t || NzResizeHandleComponent)(core.ɵɵdirectiveInject(NzResizableService), core.ɵɵdirectiveInject(core.ChangeDetectorRef)); };
        /** @nocollapse */ NzResizeHandleComponent.ɵcmp = core.ɵɵdefineComponent({ type: NzResizeHandleComponent, selectors: [["nz-resize-handle"], ["", "nz-resize-handle", ""]], hostBindings: function NzResizeHandleComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
                core.ɵɵallocHostVars(3);
                core.ɵɵlistener("mousedown", function NzResizeHandleComponent_mousedown_HostBindingHandler($event) { return ctx.onMousedown($event); })("touchstart", function NzResizeHandleComponent_touchstart_HostBindingHandler($event) { return ctx.onMousedown($event); });
            } if (rf & 2) {
                core.ɵɵclassMap("nz-resizable-handle nz-resizable-handle-" + ctx.nzDirection);
                core.ɵɵclassProp("nz-resizable-handle-box-hover", ctx.entered);
    ...
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(NzResizeHandleComponent, [{
            type: core.Component,
            args: [{
        ...
        }], function () { return [{ type: NzResizableService }, { type: core.ChangeDetectorRef }]; }, { nzDirection: [{
                type: core.Input
            }], nzMouseDown: [{
                type: core.Output
            }] }); })();
    ...
    function NzResizeHandlesComponent_nz_resize_handle_0_Template(rf, ctx) { if (rf & 1) {
        core.ɵɵelement(0, "nz-resize-handle", 1);
    } if (rf & 2) {
        var dir_r317 = ctx.$implicit;
        core.ɵɵproperty("nzDirection", dir_r317);
    } }
    ...
    var NzResizeHandlesComponent = /** @class */ (function () {
        ...
        /** @nocollapse */ NzResizeHandlesComponent.ɵcmp = core.ɵɵdefineComponent({ type: NzResizeHandlesComponent, selectors: [["nz-resize-handles"]], inputs: { nzDirections: "nzDirections" }, exportAs: ["nzResizeHandles"], features: [core.ɵɵNgOnChangesFeature()], decls: 1, vars: 1, consts: [[3, "nzDirection", 4, "ngFor", "ngForOf"], [3, "nzDirection"]], template: function NzResizeHandlesComponent_Template(rf, ctx) { if (rf & 1) {
                core.ɵɵtemplate(0, NzResizeHandlesComponent_nz_resize_handle_0_Template, 1, 1, "nz-resize-handle", 0);
            } if (rf & 2) {
                core.ɵɵproperty("ngForOf", ctx.directions);
            } }, directives: [common.NgForOf, NzResizeHandleComponent], encapsulation: 2, changeDetection: 0 });
        return NzResizeHandlesComponent;
    }());
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(NzResizeHandlesComponent, [{
            type: core.Component,
            args: [{
    ...
    var NzResizableModule = /** @class */ (function () {
        ...
        /** @nocollapse */ NzResizableModule.ɵmod = core.ɵɵdefineNgModule({ type: NzResizableModule });
        /** @nocollapse */ NzResizableModule.ɵinj = core.ɵɵdefineInjector({ factory: function NzResizableModule_Factory(t) { return new (t || NzResizableModule)(); }, imports: [[common.CommonModule]] });
        return NzResizableModule;
    }());
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && core.ɵɵsetNgModuleScope(NzResizableModule, { declarations: [NzResizableDirective, NzResizeHandleComponent, NzResizeHandlesComponent], imports: [common.CommonModule], exports: [NzResizableDirective, NzResizeHandleComponent, NzResizeHandlesComponent] }); })();
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(NzResizableModule, [{
            type: core.NgModule,
            args: [{
